...
const galleryImages = [
  {
    id: 1,
    src: "/placeholder.svg?height=800&width=1200&query=buddhist%20temple%20exterior%20with%20golden%20roof",
  ...
  {
    id: 2,
    src: "/placeholder.svg?height=800&width=1200&query=buddhist%20meditation%20hall%20with%20large%20buddha%20statue",
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mb-12">
          <Tabs defaultValue="all" value={activeCategory} onValueChange={setActiveCategory} className="w-full">
            <TabsList className="w-full max-w-4xl mx-auto flex flex-wrap justify-center bg-white/80 backdrop-blur-sm p-1 rounded-full">
              ...
              >
                {filteredImages.map((image, index) => (
                  <motion.div
                    ...
                    className="group relative overflow-hidden rounded-lg aspect-[4/3] cursor-pointer shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6 z-20">
                      <h3 className="text-white text-lg font-medium mb-2">{image.alt}</h3>
        ...
        <Dialog open={selectedImage !== null} onOpenChange={closeLightbox}>
          <DialogContent className="max-w-6xl p-0 bg-black/95 border-none overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6 z-20">
                  <AnimatePresence>
                    {isInfoOpen ? (
                      ...
                      >
                        <h3 className="text-lg font-medium">{filteredImages[selectedImage].alt}</h3>
                        <p className="text-white/80">{filteredImages[selectedImage].caption}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
