          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative overflow-hidden">
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <h3 className="text-2xl font-serif mb-3">Meditation Programs</h3>
            ...
            <div className="group relative overflow-hidden">
              ...
              />
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <h3 className="text-2xl font-serif mb-3">Dhamma Teachings</h3>
                <p className="text-white/80 mb-6 line-clamp-3">
            ...
            <div className="group relative overflow-hidden">
              ...
              />
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <h3 className="text-2xl font-serif mb-3">Cultural Ceremonies</h3>
                <p className="text-white/80 mb-6 line-clamp-3">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-4">
                <Button asChild className="bg-amber-600 hover:bg-amber-700 rounded-none px-8 py-6">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-light text-stone-800 mt-3 mb-6">Upcoming Events</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {upcomingEvents.map((event, index) => (
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="text-xl font-medium text-stone-800 mb-4 group-hover:text-amber-600 transition-colors">
                    {event.title}
                  </h3>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-light mt-3 mb-6">Virtual Temple Tour</h2>
              <div className="h-px w-20 bg-amber-500 mb-8"></div>
