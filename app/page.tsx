  ...
  return (
    <main className="overflow-hidden">
      ...
      >
        ...
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px] relative z-10 px-4 md:px-6 py-20 md:py-32">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-3xl font-light leading-relaxed mb-16">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-center text-white/80">
          <p className="text-lg md:text-xl italic font-serif mb-2">"Sabbe sattā sukhi hontu"</p>
          <p className="text-sm md:text-base">May all beings be happy</p>
      ...
      <section
        className="py-24 bg-stone-900 text-white relative"
        style={{ minHeight: "600px", fontSize: "clamp(16px, 1vw, 18px)" }}
      >
        <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-black to-transparent"></div>
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px]">
          <div className="text-center mb-16">
            <span className="text-amber-500 text-sm tracking-widest uppercase font-medium">Our Offerings</span>
            <h2 className="text-4xl md:text-5xl font-serif font-light mt-3 mb-6" style={{ minWidth: "fit-content" }}>
              Spiritual Journey
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8" style={{ minWidth: "320px" }}>
            {/* Program Card 1 */}
            <div className="group relative overflow-hidden">
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <h3 className="text-2xl font-serif mb-3" style={{ minWidth: "fit-content" }}>
                  Meditation Programs
                </h3>
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-fit border-amber-500 text-amber-400 hover:bg-amber-500/20 rounded-none group"
                  style={{ minWidth: "fit-content" }}
                >
      ...
      <section className="py-24 bg-white relative" style={{ fontSize: "clamp(16px, 1vw, 18px)" }}>
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px]">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  asChild
                  className="bg-amber-600 hover:bg-amber-700 rounded-none px-8 py-6"
                  style={{ minWidth: "fit-content" }}
                >
      ...
      <section className="py-24 bg-stone-100 relative" style={{ fontSize: "clamp(16px, 1vw, 18px)" }}>
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px]">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16">
            ...
            <Button
              asChild
              variant="outline"
              className="mt-6 md:mt-0 border-amber-600 text-amber-700 hover:bg-amber-50 rounded-none group"
              style={{ minWidth: "fit-content" }}
            >
          ...
          <div className="grid md:grid-cols-3 gap-8" style={{ minWidth: "320px" }}>
            {upcomingEvents.map((event, index) => (
              <Link
                ...
                className="group block bg-white overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
              >
              ...
              >
                <CardContent className="p-0">
                  <div className="p-8">
                    ...
                    <p className="text-stone-700 italic text-lg mb-8 leading-relaxed">{testimonial.quote}</p>
      ...
      <section className="py-24 bg-stone-900 text-white relative" style={{ fontSize: "clamp(16px, 1vw, 18px)" }}>
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px]">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
            ...
            <div className="relative">
              <div className="aspect-video bg-stone-800 rounded-lg overflow-hidden shadow-2xl relative group">
                <img
      ...
      <section className="py-24 bg-amber-50 relative" style={{ fontSize: "clamp(16px, 1vw, 18px)" }}>
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px]">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white p-12 shadow-xl relative">
              ...
              <div className="text-center mb-8">
                <span className="text-amber-600 text-sm tracking-widest uppercase font-medium">Stay Connected</span>
                <h2
      ...
      <section className="py-24 bg-stone-900 text-white relative" style={{ fontSize: "clamp(16px, 1vw, 18px)" }}>
        ...
        />
        <div className="container max-w-7xl mx-auto px-4 md:px-6 min-w-[320px] relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-serif font-light mb-6" style={{ minWidth: "fit-content" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white/10 rounded-none px-10 py-7 text-lg"
                style={{ minWidth: "fit-content" }}
              >
