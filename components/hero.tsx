...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-20 text-center px-4 py-16 sm:py-20 md:py-24">
        ...
        <p className="text-base sm:text-lg md:text-xl italic text-white/80 mb-2 max-w-xl mx-auto">
          "Sabbe sattā sukhi hontu"
        </p>
        <p className="text-xs sm:text-sm md:text-base text-white/70 mb-8 sm:mb-10 max-w-xl mx-auto">
          May all beings be happy
        </p>
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center">
          <Button asChild size="lg" className="bg-amber-600 hover:bg-amber-700 w-full sm:w-auto">
